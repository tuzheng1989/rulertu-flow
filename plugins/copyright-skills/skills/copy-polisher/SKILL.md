...
name: copy-polisher
description: |
  去除中文文稿中的 AI 生成痕迹，面向软著申报材料与正式文书场景。两种模式：改稿
  （默认，做最小有效编辑，保留作者声音，不改任何事实）与检测（逐条点名套路、引用
  原句、给一句话改法，不重写、不打分、不猜作者）。基于维基百科"AI 写作特征"综合
  指南，参考 petergyang/no-ai-slop。当用户提到 改稿、去 AI 味、文书打磨、申报
  材料文字 时使用。
allowed-tools:
  - Read
  - Write
