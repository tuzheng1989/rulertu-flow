# Deep Agents Code - Deep Agents

Source: https://docs.langchain.com/oss/python/deepagents/code-link.md
...
<Frame>
  <video autoPlay muted loop playsInline className="w-full aspect-video rounded-xl" src="https://mintcdn.com/langchain-5e9cc07a/RVTbVyxmLiI04cgS/oss/images/deepagents/dcode-small.mp4" aria-label="Deep Agents Code terminal demo" data-path="oss/images/deepagents/dcode-small.mp4">
