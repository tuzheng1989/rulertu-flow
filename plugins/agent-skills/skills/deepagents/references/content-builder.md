# Build a content builder agent - Deep Agents

Source: https://docs.langchain.com/oss/python/deepagents/content-builder.md
...
def generate_cover(prompt: str, slug: str) -> str:
    ...
    Args:
        ...
        slug: Blog post slug. Image saves to blogs//hero.png
    """
    try:
...
def generate_social_image(prompt: str, platform: str, slug: str) -> str:
    ...
    Args:
        ...
        slug: Post slug. Image saves to //image.png
    """
    try:
        from google import genai
...
* Add skills under `skills//SKILL.md` for new content types
