# A2A endpoint in Agent Server - Deep Agents

Source: https://docs.langchain.com/oss/python/deepagents/a2a.md
...
async def run_conversation(agent_a_url, agent_b_url):
    ...
    # use that instead â€” this keeps the A2A context and LangSmith thread in sync.
