# Comparison with Claude Agent SDK - Deep Agents

Source: https://docs.langchain.com/oss/python/deepagents/comparison.md
...
* **Managed:** create, run, and operate deep agents with [Managed Deep Agents](/langsmith/deploy-managed-deep-agent) in LangSmith.
